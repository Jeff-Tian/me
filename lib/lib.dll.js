...
var Nerv = _interopDefault(__webpack_require__(0));
...
var createHistory = function createHistory(props) {
  ...
  Taro__default._set$router(initialLocation);
  ...
  var setState = function setState(nextState) {
    ...
    Taro__default._set$router(history.location);
...
function (_Component) {
  ...
  _createClass(Router, [{
    ...
    value: function computeMatch(location) {
      ...
      var foundRoute = this.customRoutes.find(function (_ref) {
      ...
      var matchedRoute = this.props.routes.find(function (_ref3) {
        var path = _ref3.path,
    ...
    value: function render() {
      ...
      var router = this;
      var currentLocation = Taro__default.getRouter();
  ...
  _createClass(Router$$1, [{
    ...
    value: function componentWillMount() {
      var _this$props = this.props,
          ...
          customRoutes = _this$props.customRoutes;
      var firstPagePath = routes[0].path;
    ...
    key: "render",
    value: function render() {
      return Nerv.createElement(Router, {
...
var isMacSafari = navigator && navigator.platform && /mac/i.test(navigator.platform) && /^((?!chrome|android).)*safari/i.test(navigator.userAgent);
